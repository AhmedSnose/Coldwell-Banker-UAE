...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({ 
  ...
  const variants = {
    primary: 'bg-[linear-gradient(131deg,#ff9797_0%,_#8053ff_100%)] text-global-2 hover:opacity-90 active:opacity-80 focus:ring-purple-500',
    secondary: 'bg-global-6 text-global-1 hover:bg-global-5 active:bg-global-4 focus:ring-gray-300',
    outline: 'border border-global-5 text-global-1 bg-transparent hover:bg-global-6 active:bg-global-5 focus:ring-gray-300',
    ghost: 'text-global-1 bg-transparent hover:bg-global-6 active:bg-global-5 focus:ring-gray-300',
  ...
  const sizes = {
    ...
    md: 'px-[14px] py-[5px] text-sm sm:px-[28px] sm:py-[10px] sm:text-base md:text-base',
